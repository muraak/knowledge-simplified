...
<link rel="stylesheet" href="<%= request.getContextPath() %>/css/page-protect-account-30a753af9e.css"/>
</c:param>

<c:param name="PARAM_SCRIPTS">
<script src="<%= request.getContextPath() %>/js/page-protect-account-70275faa90.js"></script>
</c:param>
