...
<link rel="stylesheet" href="<%= request.getContextPath() %>/css/page-protect-group-a4d89cad23.css"/>
</c:param>
<c:param name="PARAM_SCRIPTS">
<script src="<%= request.getContextPath() %>/js/page-protect-group-c140b1d02e.js"></script>
<script>
