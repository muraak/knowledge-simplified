...
<link rel="stylesheet" href="<%= request.getContextPath() %>/css/notification-list-e4022ac225.css"/>
</c:param>
...
<script src="<%= request.getContextPath() %>/js/page-notification-list-f20b050bd9.js"></script>
</c:param>
