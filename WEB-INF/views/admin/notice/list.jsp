...
<link rel="stylesheet" href="<%= request.getContextPath() %>/css/page-notice-list-65b8c6668f.css"/>
    </c:param>

    <c:param name="PARAM_SCRIPTS">
<script src="<%= request.getContextPath() %>/js/page-notice-list-f3791df017.js"></script>
