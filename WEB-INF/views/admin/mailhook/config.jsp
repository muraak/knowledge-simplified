...
<link rel="stylesheet" href="<%= request.getContextPath() %>/css/admin-mailhook-config-5dc2f4aa70.css"/>
</c:param>

<c:param name="PARAM_SCRIPTS">
<script src="<%= request.getContextPath() %>/js/page-mailhook-config-9262f50632.js"></script>
