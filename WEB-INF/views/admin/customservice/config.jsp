...
<link rel="stylesheet" href="<%= request.getContextPath() %>/css/admin-system-config-5dc2f4aa70.css"/>
    </c:param>

    <c:param name="PARAM_SCRIPTS">
<script src="<%= request.getContextPath() %>/js/page-customservice-5125c04fa9.js"></script>
