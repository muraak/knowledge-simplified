...
<link rel="stylesheet" href="<%= request.getContextPath() %>/css/page-open-account-e4022ac225.css"/>
</c:param>

<c:param name="PARAM_SCRIPTS">
<script src="<%= request.getContextPath() %>/js/page-open-account-21ad87ec56.js"></script>
</c:param>
