...
<link rel="stylesheet" href="<%= request.getContextPath() %>/css/page-knowledge-search-5686db5dbc.css"/>
</c:param>

<c:param name="PARAM_SCRIPTS">
<script src="<%= request.getContextPath() %>/js/page-knowledge-search-41b813c36b.js"></script>
