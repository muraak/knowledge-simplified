...
<link rel="stylesheet" href="<%= request.getContextPath() %>/css/page-open-notice-37ddbaa188.css"/>
    </c:param>
...
<script src="<%= request.getContextPath() %>/js/page-open-notice-e6e84659a3.js"></script>
    </c:param>
